...
var Produccion = {
    //Maquinas - Variaciones de Produccion
...
var Comercial = {
    ...
    CalcularCostoPlanchasTroqueles: function () {
        if ($("#hdfProdCotizar").val()) {
            ...
            var datos = { arrProductos: arrProds };
            ...
            $.ajax({
                ...
                traditional: true,
                success: function (data) {
                    $("#valoresplancha").val(1);
                    $("#valorestroqueles").val(1);
                }
            });
        }
        else {
